function formValidate() {
	...
	let fifGrade = document.registration.bc;
	...
	function validfirstChoice(firstChoice) {
		if (firstChoice.value == "default") {
			alert ("Please select your first course!");
			firstChoice.focus();
			return false;
		} else {
			return true;
	...
	function validsecondChoice(secondChoice) {
		if (secondChoice.value == "default") {
			alert ("Please select your second course!");
			secondChoice.focus();
			return false;
		} else {
			return true;
	...
	function validthirdChoice(thirdChoice) {
		if (thirdChoice.value == "default") {
			alert ("Please select your select course!");
			thirdChoice.focus();
			return false;
		} else {
			return true;
	...
	function validhostel(yHostel,nHostel) {
		...
		if (x == 0) {
			alert ("Please make a selection of hostel!");
			yHostel.focus();
			return false;
		} else {
			return true;
	...
	function validenName(enName,mn,mx) {
		...
		if (enName.value.match(letters)) {
			return true;
		} else {
			alert ("Please make sure your name are in alphabet characters only!");
			enName.focus();
			return false;
		}
	}
	...
	function validschool(secondary) {
		...
		if (secondary.value.match(letters)) {
			...
			alert ("Please enter your secondary school!");
			secondary.focus();
			return false;
		}
	}
	...
	function validfGrade(fGrade) {
		...
		if (fGrade.value.match(grade)) {
			...
			alert ("Please enter the 'Bahasa Melayu' grade! The grade only between A-G / a-g!");
			fGrade.focus();
			return false;
		}
	}
	...
	function validscGrade(scGrade) {
		...
		if (scGrade.value.match(grade)) {
			...
			alert ("Please enter the 'Sejarah' grade! The grade only between A-G / a-g!");
			scGrade.focus();
			return false;
		}
	}
	...
	function validtGrade(tGrade) {
		...
		if (tGrade.value.match(grade)) {
			...
			alert ("Please enter the 'Matematik' grade! The grade only between A-G / a-g!");
			tGrade.focus();
			return false;
		}
	}
	...
	function validfourGrade(fourGrade) {
		...
		if (fourGrade.value.match(grade)) {
			...
			alert ("Please enter the 'Bahasa Inggeris' grade! The grade only between A-G / a-g!");
			fourGrade.focus();
			return false;
		}
	}
	...
	function validfifGrade(fifGrade) {
		var grade = /^[A-Ga-g]+$/;
		if (fifGrade.value.match(grade)) {
			alert('Form successfully submitted');
			window.location.reload();
			return true;
		} else {
			alert ("Please enter the 'Bahasa Cina' grade! The grade only between A-G / a-g!");
			fifGrade.focus();
			return false;
		}
	}
